...
const ProductCard = memo(function ProductCard({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden h-full flex flex-col will-change-transform">
      <div className="relative group">
        ...
        <button 
          ...
          className="absolute top-0 left-0 m-2 p-1.5 bg-white dark:bg-gray-700 rounded-full shadow-sm hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200"
        >
          <Heart 
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4">
          <button
            ...
            className={`w-full flex items-center justify-center space-x-2 py-2 rounded-md transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] ${
              product.stock > 0
